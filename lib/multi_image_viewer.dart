...
class MultiImageViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final captionList =
        images.any((image) => image.caption != null && image.caption!.isNotEmpty) ? images.map((image) => image.caption ?? '').toList() : null;
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(image: NetworkImage(images.first.imageUrl), fit: BoxFit.cover),
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: backgroundColor,
                        image: DecorationImage(image: NetworkImage(images[1].imageUrl), fit: BoxFit.cover),
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: () => openImage(context, 2, imagesList, captionList),
                  child: Container(
                    width: width == null ? defaultWidth / 2 : width! / 2,
                    decoration: BoxDecoration(
                        color: backgroundColor,
                        image: DecorationImage(image: NetworkImage(images[2].imageUrl), fit: BoxFit.cover),
                        borderRadius: const BorderRadius.only(topRight: Radius.circular(5), bottomRight: Radius.circular(5))),
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () => openImage(context, 3, imagesList, captionList),
                        child: Container(
                          width: width == null ? defaultWidth / 2 : width! / 2,
                          decoration: BoxDecoration(
                              color: backgroundColor,
                              image: DecorationImage(image: NetworkImage(images[3].imageUrl), fit: BoxFit.cover),
